	...
	//WebDriverWait w = new WebDriverWait(wd,Duration.ofSeconds(10));
	 ...
	 public WebDriver wd;
	  ...
	  public void login1() throws InterruptedException {
		...
		wd.get("https://kiosknewst.bank.sbi/unifyapp/login/");
		
		WebElement username=wd.findElement(By.xpath("//body/div[@id='root']/div[@class='container']/div[@class='row']/div[@class='col-lg-4 col-lg-6 col-md-8 col-sm-6 col-6']/div/div[@class='row']/form[@autocomplete='off']/div[@class='col']/div/div/div[@class='mb-2 form-floating']/div[@class='MuiFormControl-root MuiTextField-root formCOntrol css-my3z44']/div[@class='MuiInputBase-root MuiOutlinedInput-root MuiInputBase-colorPrimary MuiInputBase-formControl css-hrw1di']/input[1]"));
		
		username.sendKeys("3K580037");
		
		WebElement password= wd.findElement(By.xpath("//form[@autocomplete='off']//div//div[@class='col']//div//div//input[@id='outlined-basic']"));
		
		password.sendKeys("Asd@1234");
		
		String captcha;
		captcha = JOptionPane.showInputDialog("Please Enter The Captcha");
		WebElement Captcha = wd.findElement(By.xpath("//div[@class='col-lg-71 col-md-6 col-sm-10 col-9']//div//div//input[@id='outlined-basic']"));
		...
		WebElement fp = wd.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div/div/div[2]/div/div/img"));
