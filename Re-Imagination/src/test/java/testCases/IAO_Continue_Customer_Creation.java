...
public class IAO_Continue_Customer_Creation extends BaseClass{
	...
	try {
		...
		ao.clickOnNomineeDetailsTab();				logger.info("** Clicked on NomineeDetails Tab 1***");
		ao.clickOnNomineeDetailsTab();				logger.info("** Clicked on NomineeDetails Tab 2***");
		ao.clickProceedToPreview();					logger.info("** Clicked on Proceed to Preview ***");
		Thread.sleep(2000);
		ao.clickProceedToCustAuth();				logger.info("** Clicked on Proceed to CustAuth ***");
		ao.clickOkAepsConsent();					logger.info("** Clicked on Ok Aeps Consent ***");
